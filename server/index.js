...
app.get('/legs', (req, res) => {
  pool.query('select id, (select runner from runners where id = legs.runner) as runner, distance, complete, start_time, end_time, dif, runner as runner_id from legs', (err, data) => {
    if (err) {
